...
-- Scope: all visible user procedure and SQL function definitions in the current DB.
-- Obtain whole-database scope/confidentiality approval and protect output BEFORE acquisition.
-- Stored definitions may contain secrets; share only an approved sanitized projection.
-- Legacy inspection aid, not a qualified deployment/replay script.
-- Notes:
